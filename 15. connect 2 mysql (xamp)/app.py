...
def home():
    ...
    if request.method == "POST":
        ...
        db_connector.execute(" insert into employee_details (Name, Email, Company_Id, DOB, Salary) values(%s,%s,%s,%s,%s)", (name, email, company_id, dob, salary))
        db_instance.commit()
        db_connector.close()
        return render_template("employees.html", employee_info = employee_form_data)
